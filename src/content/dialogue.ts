...
export const DIALOGUES: Record<string, DialogueNode> = {
  ...
  chris_intro: {
    id: 'chris_intro',
    speaker: 'Chris',
    text: "You actually did it. The claim that vanished, the Wraith, the Reaper, the Quarterly Audit at the end — you walked the entire revenue cycle and came out the other side. Most people never see how the machine really works. You just beat it.",
    next: 'chris_intro_2',
  },
  chris_intro_2: {
    id: 'chris_intro_2',
    speaker: 'Chris',
    text: "Here's the thing nobody tells you: the rev cycle isn't magic and it isn't malice. It's a thousand small decisions, each one legible if you're willing to look. You looked.",
    next: 'chris_intro_3',
  },
  chris_intro_3: {
    id: 'chris_intro_3',
    speaker: 'Chris',
    text: "And every denial you overturned was somebody's bill that didn't have to wreck their month. That adds up. That's the whole point of the work.",
    next: 'chris_intro_4',
  },
  chris_intro_4: {
    id: 'chris_intro_4',
    speaker: 'Chris',
    text: "We have a knack for turning skeptics into believers around here. Took you a few levels — but look at you now, reading a CMS-1500 like a map.",
    next: 'chris_intro_5',
  },
  chris_intro_5: {
    id: 'chris_intro_5',
    speaker: 'Chris',
    text: "Go take a breath. You earned it. The data's still out there waiting for someone who knows how to ask it the right questions — and now that's you. Welcome to the other side.",
  },
  adam_intro: {
    id: 'adam_intro',
    speaker: 'Adam',
    text: "Hey — congratulations. Seriously. You closed every case, traced every contract, and beat the Quarterly Audit. That is not a small thing. Most claims never find anyone willing to chase them this far.",
    next: 'adam_intro_2',
  },
  adam_intro_2: {
    id: 'adam_intro_2',
    speaker: 'Adam',
    text: "What you did is the whole job, honestly: close the gap between 'someone should fix this' and 'someone fixed this.' You closed it, over and over, until the audit had nothing left to find.",
    next: 'adam_intro_3',
  },
  adam_intro_3: {
    id: 'adam_intro_3',
    speaker: 'Adam',
    text: "The forms, the codes, the appeals — none of it is built to be understandable. You made it understandable anyway. That's the trick, and you've got it now.",
    next: 'adam_intro_4',
  },
  adam_intro_4: {
    id: 'adam_intro_4',
    speaker: 'Adam',
    text: "And you didn't do it alone. Pat, Liana, Sam, Dana — every person who handed you a case is part of how this got solved. When something finally works, name everyone who touched it. The chain is longer than it looks.",
    next: 'adam_intro_5',
  },
  adam_intro_5: {
    id: 'adam_intro_5',
    speaker: 'Adam',
    text: "Take the win. You turned a single vanished claim into a complete run through the underworld and back. Not many people make it to this room. Glad you're here.",
  },
