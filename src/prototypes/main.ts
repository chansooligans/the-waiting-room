...
const prototypes: Prototype[] = [
  ...
  },
  {
    ...
    subtitle: '@ L18 — third-sibling prototype',
    archetype: 'Reaper',
    carc: 'CO-29',
    targetLevel: 18,
    status: 'shipped',
  ...
  },
  {
    ...
    subtitle: '@ L12 — seventh-sibling prototype',
    archetype: 'Swarm',
    carc: 'CO-16',
    targetLevel: 12,
    status: 'shipped',
  ...
  },
  {
    ...
    subtitle: '@ L3 — fifth-sibling prototype',
    archetype: 'Fog',
    carc: 'pre-submit',
    targetLevel: 3,
    status: 'shipped',
  ...
  },
  {
    ...
    subtitle: '@ L25 — eighth-sibling prototype',
    archetype: 'Specter',
    carc: 'CO-45 (hidden)',
    targetLevel: 25,
    status: 'shipped',
  ...
  },
  {
    ...
    subtitle: '@ L32 — twelfth-sibling prototype · the finale',
  ...
  },
  {
    ...
    subtitle: '@ L19 — eleventh-sibling prototype',
    archetype: 'Specter',
    carc: 'NSA-protected',
    targetLevel: 19,
    status: 'shipped',
  ...
  },
  {
    ...
    subtitle: '@ L9 — tenth-sibling prototype',
  ...
  },
  {
    ...
    subtitle: '@ L13 — promoted from free-roam',
...

  {
    ...
    subtitle: '@ L30 — duplicate-discount + HRSA self-disclosure',
    archetype: 'Specter',
...

  {
    id: 'idr-crucible',
    title: 'IDR Crucible',
    subtitle: '@ L29 — NSA Independent Dispute Resolution',
    archetype: 'Crucible',
...

  {
    ...
    subtitle: '@ L24 — Medicare 2-midnight rule + RAC observation reclassification',
    archetype: 'Mire',
...

  {
    ...
    subtitle: '@ L26 — birthday rule + MSP + payer-of-last-resort',
    archetype: 'Spider',
...

  {
    ...
    subtitle: '@ L8 — fourth-sibling prototype',
...

  {
    ...
    subtitle: '@ L21 — wrong-MRN identity merge',
    archetype: 'Phantom',
...

  {
    ...
    subtitle: '@ L22 — HCC under-capture for Medicare Advantage',
    archetype: 'Hollow',
...

  {
    ...
    subtitle: '@ L15 — provider not in-network for DOS',
    archetype: 'Lattice',
...

  {
    id: 'hipaa-spider',
    title: 'HIPAA Spider',
    subtitle: '@ L31 — HIPAA breach response (under-500 path)',
    archetype: 'Spider',
...

  {
    id: 'no-show-bill',
    title: 'No-Show Bill',
    subtitle: '@ L7 — release valve (Lighthouse companion)',
...

  {
    ...
    subtitle: '@ L27 — pricing-methodology sibling to the Specter',
    archetype: 'Specter',
...

  {
    ...
    subtitle: '@ L28 — pricing-transparency Case (two axes: coding mode × rate source)',
...

  {
    id: 'gfe-oracle',
    title: 'GFE Oracle',
    subtitle: '@ L10 — pre-service patient-facing prevention',
    archetype: 'Oracle',
...

  {
    ...
    subtitle: '@ L16 — two-bills-for-one-visit; walk the contract chain',
    archetype: 'Phantom',
...

  {
    ...
    subtitle: '@ catalog — wrong-form Case (facility on a 1500)',
    archetype: 'Mirror',
...

  {
    ...
    subtitle: '@ L17 — meta-Case on AMA\'s CPT licensing system',
    archetype: 'Mire',
...

  {
    ...
    subtitle: '@ L2 — drug pricing reconciliation (Part B J-codes)',
...

  {
    ...
    subtitle: '@ L23 — UHC chemo case rate bundles drug; CDM doesn\'t know',
    archetype: 'Specter',
...

  {
    ...
    subtitle: '@ L6 — UHC OPG bypassed by wrong rev code',
    archetype: 'Specter',
...

  {
    ...
    subtitle: '@ L14 — high-cost implant outside the case rate',
    archetype: 'Specter',
...

  {
    ...
    subtitle: '@ L20 — case rate + per-diem hybrid contract',
    archetype: 'Specter',
